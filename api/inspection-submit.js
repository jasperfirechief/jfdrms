...
export default async function handler(req,res){
  ...
  try{
    ...
    const row={apparatus_id:body.apparatus_id||null,inspector_user_id:caller.id,inspection_date:body.inspection_date,inspection_time:body.inspection_time,status:"complete",notes:body.acceptance_test_notes||"",checklist:body.results||{},occupancy_name:body.occupancy_name,occupancy_type:body.occupancy_type||null,occupancy_group:body.occupancy_group||null,square_footage:body.square_footage||null,stories:body.stories||null,inspection_type:body.inspection_type,acceptance_type:body.acceptance_type||null,acceptance_tests:body.acceptance_tests||{},address:body.address,city_state_zip:body.city_state_zip,contact_name:body.contact_name,contact_phone:body.contact_phone,phone:body.phone,email:body.email,acceptance_test_result:body.acceptance_test_result||"N/A",results:body.results||{},remarks:body.remarks||"",reinspection_date:body.reinspection_date||null,representative_signature:body.representative_signature||null,representative_signature_date:body.representative_signature_date||body.inspection_date,attachments:body.attachments||[]};
